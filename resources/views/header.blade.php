...
<body class="gray-bg">
    <main class="header-expand">
        ...
        <header class="dark-bg">
            ...
            <nav>
                <ul>
                    <li class="menu-item-has-children"><a href="#" title=""><i class="icon ion-android-contact"></i><span>Clientes</span></a>
                        <ul class="children">
                            <li><a href="{{url('cliempresa')}}" title="">Cadastrar Empresa</a></li>
                            <li><a href="{{url('clieindividual')}}" title="">Cadastrar Individual</a></li>
                            <li><a href="{{url('clieautomovel')}}" title="">Cadastrar Automóvel</a></li>
                            <li><a href="{{url('contrato')}}" title="">Contrato</a></li>
                            <li><a href="{{url('recarregamento')}}" title="">Recaregamento</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children"><a href="#" title=""><i class="icon ion-ios-briefcase"></i><span>Relatórios</span></a>
                        <ul class="children">
                            <li><a href="{{url('relatorio')}}" title="">Vendas Empresa</a></li>
                            <li><a href="{{url('relatorio')}}" title="">Vendas Individual</a></li>
                            <li><a href="{{url('Clientes-Empresa')}}" title="">Listagem dos Clientes</a></li>
                            <li><a href="{{url('automovel')}}" title="">Listagem dos Automóveis</a></li>
                            
                            <li><a href="grids.html" title="">Stock</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children"><a href="#" title=""><i class="icon ion-fireball"></i><span>Configuraçoes</span></a>
                        <ul class="children">
                            <li><a href="font-awesome-icons.html" title="">Perfis</a></li>
                            <li><a href="themify-icons.html" title="">Dados do Sistema</a></li>
                            <li><a href="ionicons.html" title="">Ajuda</a></li>
                        </ul>
                    </li>
                </ul>
            </nav><!-- Nav -->
