        ...
        <div class="row mrg20">
            <div class="col-md-12 col-sm-12 col-lg-12">
                <div class="wdgt-box frm-wrp">
                    <form class="cont-frm" method="post" action="{{url('clieindividual')}}">
                        @csrf
                        <div class="row mrg20">
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <label>Cliente Individual</label>
                                <div class="slct-box2">
                                    <select name="utilizador_id" id="utilizador_id">
                                        <option>Seleccione a Empresa</option>
                                        @foreach($utilizador as $e)
                            ...
                            <div class="col-md-6 col-sm-6 col-lg-6">
                                <label>Bilhete de Identificação</label>
                                <input type="text" name="bi" id="bi" placeholder="Endereço">
                            </div>
                            <!-- <div class="col-md-12 col-sm-12 col-lg-12">
